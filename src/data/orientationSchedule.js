...
export const SCHEDULE_VERSIONS = [
  {
    ...
    events: [
      ...
      },
      {
        ...
        importance: 'high',
        preparation: ['了解本专业培养方案'],
        tip: '计算机科学与技术专业在511教室。',
        archived: true,
      },
      {
        id: 'sep15-party-application',
        date: '2026-09-15',
        time: '12:00',
        endTime: '12:00',
        location: '各班团支书处',
        ...
        category: 'other',
        importance: 'high',
        preparation: ['手写入党申请书（师大400字方格纸，文化街有售）', '字数3000左右', '按照海然老师的文书撰写要求撰写'],
        tip: '如有志愿加入中国共产党的同学，请按照今天海然老师的文书撰写要求，手写入党申请书（师大400字方格纸，文化街有售，字数3000左右。），在9月14日前交给各班团支书（我们可以15日中午12点前交到团支书手上即可），团支书在9月15日前汇总交给王娇同学。',
        deadline: '2026-09-15 12:00',
        image: '/images/party-application-guide.jpg',
        category: 'other',
      },
      {
        id: 'sep15-calligraphy-volunteer',
        date: '2026-09-15',
        time: '12:00',
        endTime: '12:00',
        location: '线上报名',
        topic: '【校团委招募】廉洁教育书法课堂挥旗志愿者招募',
        audience: '全体研究生（男生优先）',
        speaker: '校团委',
        category: 'other',
        importance: 'normal',
        preparation: ['男生', '身高175-180cm优先', '发色为黑色、深棕色', '仪容整洁、精神面貌良好'],
        tip: '共招募22名挥旗志愿者。要求：男生，身高175–180cm优先（人员不足可适当放宽条件），发色为黑色、深棕色，仪容整洁、精神面貌良好，服从统一安排，按时参与彩排及正式活动，无无故缺席、迟到现象。成功录取并全程参与活动，可统一加综测文体奖励分2分。报名截止时间：9月15日12：00（名额紧缺，报满即止）。彩排、正式表演时间：待定，后续统一通知。',
        deadline: '2026-09-15 12:00',
        link: 'https://docs.qq.com/sheet/DSm5iQWFuY2FSQWFO?right_flag=1',
        linkLabel: '报名收集表',
        category: 'other',
      },
      {
        ...
        endTime: '24:00',
        location: '志愿汇APP',
        topic: '志愿汇APP新生注册及班级组织加入',
        audience: '全体新生',
        speaker: '班长',
        category: 'other',
        importance: 'critical',
        preparation: ['下载志愿汇APP', '阅读《2026级新生志愿汇注册与加入组织指南》', '完成志愿者账号注册', '申请加入班级组织（组织名称：福师大寄望学院研究生2026级（学硕））'],
        tip: '志愿汇APP新生组织架构现已组建完成，请全体新生完成志愿汇注册及班级组织加入操作，为后续参与各类志愿服务、志愿时长认定做好准备。截止时间：9月14日24：00前。重要提醒：能否成功加入班级组织，直接影响后续志愿活动参与、志愿时长正常记录，请全体同学及时完成操作。如在注册、加入组织过程遇到问题，请及时联系本班班长反馈。组织名称为福师大寄望学院研究生2026级（学硕）。',
        deadline: '2026-09-14 24:00',
        category: 'other',
      },
      {
        id: 'sep14-study-lib',
        ...
        category: 'other',
        importance: 'normal',
        preparation: ['下载学习通APP', '完成注册', '输入邀请码yzfjsd', '绑定读者证'],
        tip: '注册登录学习通图书馆，按提示操作：1. 下载学习通APP，完成注册；2. 首页右上角"邀请码"，输入yzfjsd；3. 绑定读者证（绑定后显示"福建师范大学"，激活移动图书馆）。"我的图书馆"账号密码：默认账户即学号，默认密码@Fjnu学号（字母F为大写）；首次登录需修改密码；示例：@Fjnu136152026XXX。',
        image: '/images/study-lib-guide.jpg',
        category: 'other',
      },
      {
        id: 'sep14-league-transfer',
        date: '2026-09-14',
        time: '待定',
        endTime: '待定',
        location: '线上',
        ...
        category: 'other',
        importance: 'normal',
        preparation: ['查阅团组织关系转接培训PPT', '等待线下审查开始'],
        tip: '各位同学中午好，早上的团组织关系转接培训PPT已发群内，请查阅。目前线下审查尚未开始，暂时还不能转入组织。待审查开启后，大家先转入福建师范大学计算机与网络空间安全学院2026级新生临时团支部，各班正式团支部建好后再统一转接。有意入团的同学，发展工作预计下月底启动，参照往年要求需完成20小时志愿学时，大家可以积极参加志愿者活动。有疑问欢迎随时咨询。注意：年满28周岁会自动退团。',
        link: 'https://mp.weixin.qq.com/s/8MvSJAmcjFbpicLEHuxFgw',
        linkLabel: '团组织关系转接指南',
        category: 'other',
      },
      {
        id: 'sep14-class-start',
        date: '2026-09-14',
        time: '待定',
        endTime: '待定',
        location: '各教室',
        ...
        category: 'major',
        importance: 'high',
        preparation: ['查看课表', '准备学习用品', '注意着装仪表'],
        tip: '各位同学，研究生新生于下周（教学周第3周9月14日周一开始往后）开始正式上课，请同学们准时到教室做好相关准备，注意着装仪表，规范课堂纪律，以良好的精神面貌迎接新学期。',
        category: 'major',
      },
      {
        id: 'sep22-psy-survey',
        ...
        endTime: '18:30',
        location: '笃行1-113',
        topic: '关于开展2026级学生心理健康状况普查的通知',
        audience: '全体2026级研究生（含2025级复学学生）',
        speaker: '/',
        category: 'health',
        importance: 'high',
        preparation: ['确保手机电量充足', '携带手机'],
        tip: '请同学们准时到场，并确保手机电量能够支持答完题目。心理健康普查是了解新生心理状况的重要环节，请认真完成。',
        duration: '30分钟',
      },
      {
        id: 'sep23-checkup',
