...
.period-col td { border-bottom: 1px solid var(--border); }
.weekday-col { background: var(--soft-fg); font-weight: 700; border-right: 1px solid var(--border); border-bottom: 1px solid var(--border); }
.weekday-col:last-child { border-right: none; }
...
/* 4-5节和8-9节分隔线（只在节次列显示） */
tr.section-afternoon td.period-cell { border-top: 1px solid var(--border); }
tr.section-evening td.period-cell { border-top: 1px solid var(--border); }
